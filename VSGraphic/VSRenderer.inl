...
FORCEINLINE unsigned int VSRenderer::GetMaxActiveLight()const
{
	return m_uiMaxActiveLight;
}
...
FORCEINLINE unsigned int VSRenderer::GetVertexShaderVersion()const
{
	return m_uiVertexShaderVersion;
}
FORCEINLINE unsigned int VSRenderer::GetPixelShaderVersion()const
{
	return m_uiPixelShaderVersion;
}
