...
namespace VSEngine2
{
	...
	public:
		...
		void Draw(VSRenderer * pRenderer, unsigned int uiLayer);
	protected:
		virtual void OnDraw(VSRenderer * pRenderer, unsigned int uiLayer) = 0;
	...
	public:
		...
		virtual void OnDraw(VSRenderer * pRenderer, unsigned int uiLayer);
	protected:
