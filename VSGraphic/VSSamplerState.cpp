...
VSPointer<VSSamplerState> VSSamplerState::CubProjectShadowSampler;
...
bool VSSamplerState::InitialDefaultState()
{
	...
	VSSamplerDesc CubProjectShadowSamplerDesc;
	CubProjectShadowSamplerDesc.m_uiMag = VSSamplerDesc::FM_LINE;
	CubProjectShadowSamplerDesc.m_uiMin = VSSamplerDesc::FM_LINE;
	CubProjectShadowSamplerDesc.m_uiCoordU = VSSamplerDesc::CM_CLAMP;
	CubProjectShadowSamplerDesc.m_uiCoordV = VSSamplerDesc::CM_CLAMP;
	CubProjectShadowSampler = VSResourceManager::CreateSamplerState(CubProjectShadowSamplerDesc);
	if (!CubProjectShadowSampler)
	{
		return 0;
	}
