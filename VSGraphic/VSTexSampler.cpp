...
{
	OutString +=VSRenderer::ms_pRenderer->Sampler(GetTexType()) + _T(" ");
	OutString += VSShaderStringFactory::ms_TexPrefix + m_ShowName.GetString() 
		+ VSRenderer::ms_pRenderer->SetRegister(VSRenderer::RT_S,uiRegisterID) +_T(";\n");
	return true;
}
