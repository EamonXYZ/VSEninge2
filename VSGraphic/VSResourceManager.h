...
namespace VSEngine2
{
	...
	struct DynamicBufferIndex
	{
		...
		bool operator ==(const DynamicBufferIndex & DBI)
		{
			return pVertexFormat == DBI.pVertexFormat && uiMeshDataType == DBI.uiMeshDataType;
		}
	};
...
#define GET_SHADER_MAP(ShaderMapName)\
		...
		static bool NewSaveMap(VSSceneMap * pMap, const TCHAR * PathName, bool bSaveResourcePath = false);
