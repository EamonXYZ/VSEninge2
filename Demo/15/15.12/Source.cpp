...
bool VSDemoWindowsApplication::OnDraw()
{
	...
	VSRenderer::ms_pRenderer->DrawText(NULL, 0, 580, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("Use Key '+' And '-' to Change Power0"));
	VSRenderer::ms_pRenderer->DrawText(NULL, 0, 600, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("Power0:%f"), Power0);
	VSRenderer::ms_pRenderer->DrawText(NULL, 0, 620, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("Use Key '[' And ']' to Change Power1"));
	VSRenderer::ms_pRenderer->DrawText(NULL, 0, 640, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("Power1:%f"), Power1);
	return true;
}
