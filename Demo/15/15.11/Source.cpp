...
bool VSDemoWindowsApplication::OnDraw()
{
	...
	VSRenderer::ms_pRenderer->DrawText(NULL, 0, 580, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("Use Key '+' And '-' to Change RoughnessSquared0"));
	VSRenderer::ms_pRenderer->DrawText(NULL, 0, 600, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("RoughnessSquared0:%f"), RoughnessSquared0);
	VSRenderer::ms_pRenderer->DrawText(NULL, 0, 620, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("Use Key '[' And ']' to Change RoughnessSquared1"));
	VSRenderer::ms_pRenderer->DrawText(NULL, 0, 640, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("RoughnessSquared1:%f"), RoughnessSquared1);
	return true;
}
