...
bool VSDemoWindowsApplication::OnDraw()
{
	...
	VSRenderer::ms_pRenderer->DrawText(NULL, 0, 580, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("Use Key '+' And '-' to Change SpecularPow0"));
	VSRenderer::ms_pRenderer->DrawText(NULL, 0, 600, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("SpecularPow0:%f"), SpecularPow0);
	VSRenderer::ms_pRenderer->DrawText(NULL, 0, 620, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("Use Key '[' And ']' to Change SpecularPow1"));
	VSRenderer::ms_pRenderer->DrawText(NULL, 0, 640, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("SpecularPow1:%f"), SpecularPow1);
	return true;
}
