...
bool VSDemoWindowsApplication::OnDraw()
{
	...
	VSRenderer::ms_pRenderer->DrawText(NULL, 0, 580, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("Use Key '+' And '-' to Change Roughness0"));
	VSRenderer::ms_pRenderer->DrawText(NULL, 0, 600, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("Roughness0:%f"), Roughness0);
	VSRenderer::ms_pRenderer->DrawText(NULL, 0, 620, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("Use Key '[' And ']' to Change Roughness1"));
	VSRenderer::ms_pRenderer->DrawText(NULL, 0, 640, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("Roughness1:%f"), Roughness1);
	return true;
}
