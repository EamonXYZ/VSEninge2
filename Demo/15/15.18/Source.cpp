...
bool VSDemoWindowsApplication::OnDraw()
{
	...
	VSRenderer::ms_pRenderer->DrawText(NULL, 0, 600, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("Use Key '+' And '-' to Change RoughnessX0"));
	VSRenderer::ms_pRenderer->DrawText(NULL, 0, 620, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("RoughnessX0:%f"), RoughnessX0);
	VSRenderer::ms_pRenderer->DrawText(NULL, 0, 640, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("Use Key '[' And ']' to Change RoughnessX1"));
	VSRenderer::ms_pRenderer->DrawText(NULL, 0, 660, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("RoughnessX1:%f"), RoughnessX1);

	VSRenderer::ms_pRenderer->DrawText(NULL, 0, 680, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("Use Key '1' And '2' to Change RoughnessY0"));
	VSRenderer::ms_pRenderer->DrawText(NULL, 0, 700, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("RoughnessY0:%f"), RoughnessY0);
	VSRenderer::ms_pRenderer->DrawText(NULL, 0, 720, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("Use Key 'F1' And 'F2' to Change RoughnessY1"));
	VSRenderer::ms_pRenderer->DrawText(NULL, 0, 740, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("RoughnessY1:%f"), RoughnessY1);
