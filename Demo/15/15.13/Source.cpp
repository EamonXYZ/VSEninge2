...
bool VSDemoWindowsApplication::OnDraw()
{
	...
	VSRenderer::ms_pRenderer->DrawText(NULL, 500, 400, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("Use Key '+' And '-' to Change Smoothness0"));
	VSRenderer::ms_pRenderer->DrawText(NULL, 500, 420, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("Smoothness0:%f"), Smoothness0);
	VSRenderer::ms_pRenderer->DrawText(NULL, 500, 440, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("Use Key '[' And ']' to Change Smoothness1"));
	VSRenderer::ms_pRenderer->DrawText(NULL, 500, 460, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("Smoothness1:%f"), Smoothness1);

	VSRenderer::ms_pRenderer->DrawText(NULL, 500, 480, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("Use Key '1' And '2' to Change Metalness0"));
	VSRenderer::ms_pRenderer->DrawText(NULL, 500, 500, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("Metalness0:%f"), Metalness0);
	VSRenderer::ms_pRenderer->DrawText(NULL, 500, 520, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("Use Key 'F1' And 'F2' to Change Metalness1"));
	VSRenderer::ms_pRenderer->DrawText(NULL, 500, 540, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("Metalness1:%f"), Metalness1);

	VSRenderer::ms_pRenderer->DrawText(NULL, 500, 560, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("Use Key '3' And '4' to Change Transparency0"));
	VSRenderer::ms_pRenderer->DrawText(NULL, 500, 580, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("Transparency0:%f"), Transparency0);
	VSRenderer::ms_pRenderer->DrawText(NULL, 500, 600, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("Use Key 'F3' And 'F4' to Change Transparency1"));
	VSRenderer::ms_pRenderer->DrawText(NULL, 500, 620, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("Transparency1:%f"), Transparency1);

	VSRenderer::ms_pRenderer->DrawText(NULL, 500, 640, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("Use Key '5' And '6' to Change K0"));
	VSRenderer::ms_pRenderer->DrawText(NULL, 500, 660, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("K0:%f"), K0);
	VSRenderer::ms_pRenderer->DrawText(NULL, 500, 680, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("Use Key 'F5' And 'F6' to Change K1"));
	VSRenderer::ms_pRenderer->DrawText(NULL, 500, 700, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("K1:%f"), K1);
	return true;
}
