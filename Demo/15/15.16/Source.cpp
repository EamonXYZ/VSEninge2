...
bool VSDemoWindowsApplication::OnDraw()
{
	...
	VSRenderer::ms_pRenderer->DrawText(NULL, 700, 400, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("Use Key '+' And '-' to Change Roughness0"));
	VSRenderer::ms_pRenderer->DrawText(NULL, 700, 420, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("Roughness0:%f"), Roughness0);
	VSRenderer::ms_pRenderer->DrawText(NULL, 700, 440, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("Use Key '[' And ']' to Change Roughness1"));
	VSRenderer::ms_pRenderer->DrawText(NULL, 700, 460, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("Roughness1:%f"), Roughness1);

	VSRenderer::ms_pRenderer->DrawText(NULL, 700, 480, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("Use Key '1' And '2' to Change C0"));
	VSRenderer::ms_pRenderer->DrawText(NULL, 700, 500, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("C0:%f"), C0);
	VSRenderer::ms_pRenderer->DrawText(NULL, 700, 520, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("Use Key 'F1' And 'F2' to Change C1"));
	VSRenderer::ms_pRenderer->DrawText(NULL, 700, 540, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("C1:%f"), C1);

	VSRenderer::ms_pRenderer->DrawText(NULL, 700, 560, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("Use Key '3' And '4' to Change R0"));
	VSRenderer::ms_pRenderer->DrawText(NULL, 700, 580, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("R0:%f"), R0);
	VSRenderer::ms_pRenderer->DrawText(NULL, 700, 600, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("Use Key 'F3' And 'F4' to Change R1"));
	VSRenderer::ms_pRenderer->DrawText(NULL, 700, 620, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("R1:%f"), R1);
