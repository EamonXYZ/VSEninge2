...
bool VSDemoWindowsApplication::OnDraw()
{
	...
	VSRenderer::ms_pRenderer->DrawText(NULL, 0, 580, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("Use Key '+' And '-' to Change SmoothAnimBlendParamter"));
	VSRenderer::ms_pRenderer->DrawText(NULL, 0, 600, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("SmoothAnimBlendParamter:%f"), m_fPencent);
	return true;
}
