...
bool VSDemoWindowsApplication::OnDraw()
{
	...
	VSRenderer::ms_pRenderer->DrawText(NULL, 0, 480, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("Use Key '+' And '-' to Change ImmediateAnimBlendParamter"));
	VSRenderer::ms_pRenderer->DrawText(NULL, 0, 500, VSColorRGBA(1.0f, 1.0f, 1.0f), _T("ImmediateAnimBlendParamter:%f"), m_fPencent);
	return true;
}
